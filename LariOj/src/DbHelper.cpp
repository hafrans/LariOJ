...
const char* DbHelper::get_host() const
{
    return __db__host_;
}

unsigned int DbHelper::get_port() const
{
    return __db__port_;
}

const char* DbHelper::get_user() const
{
    return __db__user_;
}

const char* DbHelper::get_pwd() const
{
    return __db__pwd__;
}

const char* DbHelper::get_dbn() const
{
    return __db__dfl__dbn_;
}
